...
EditText edtSchedule;
    public UserList(@NonNull Activity context, List<User> users,DatabaseReference databaseReference,EditText edtName,EditText edtDesc, EditText edtElig, EditText edtSchedule) {
        ...
        this.edtElig=edtElig;
        this.edtSchedule=edtSchedule;
    ...
    public View getView(int pos, View view, ViewGroup parent){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edtDesc.setText(user.getDesc());
                edtElig.setText(user.getElig());
                edtSchedule.setText(user.getSchedule());
                AdminProfile.userId=user.getId();
            }
        });
        return  listViewItem;
    }
